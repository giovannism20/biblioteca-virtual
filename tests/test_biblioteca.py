from controller.biblioteca import cadastrar_biblioteca, alterar_nome_biblioteca, excluir_biblioteca, listar_bibliotecas_cadastradas
from data_store import bibliotecas
from model.biblioteca import Biblioteca

def test_cadastrar_biblioteca(monkeypatch):
    ...
    assert resultado == "A biblioteca 'Biblioteca do Poyatos' foi cadastrada com sucesso!"

def test_alterar_nome_biblioteca(monkeypatch):
    bibliotecas.clear()
...
def test_excluir_biblioteca(monkeypatch):
    bibliotecas.clear()
...
def test_listar_bibliotecas_cadastradas(capfd, monkeypatch):
    bibliotecas.clear()
